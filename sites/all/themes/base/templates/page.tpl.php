		...
		<div id="header-inner" class="clearfix">
			...
			<div id="nav">
				...
				<div class="social-icons">
					<a href="http://facebook.com/udxola" class="icon-facebook" target="_blank"></a>
					<a href="http://twitter.com/udxola" class="icon-twitter" target="_blank"></a>
					<a href="http://instagram.com/udxola" class="icon-instagram" target="_blank"></a>
					<a href="http://pinterest.com/udxola" class="icon-pinterest" target="_blank"></a>
				</div>
			</div> 
